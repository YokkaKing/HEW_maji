...
void Hp_Draw()
{
    ...
    SetBlendState(BLENDSTATE_ALFA);
    DrawSpriteEx(XMFLOAT2(drawPos1.x + 125, drawPos1.y - 10), XMFLOAT2(63 * 0.6, 26 * 0.6), g_Hp.col, 1, 1, 1);
    ...
    SetBlendState(BLENDSTATE_ALFA);
    DrawSprite(XMFLOAT2(drawPos2.x - 110, drawPos2.y - 10), XMFLOAT2(102 * 0.6, 26 * 0.6), g_Hp2.col);
